...
Please refer to the [ScleraSQL Reference](https://www.scleradb.com/doc/ref/sqlexttext#sclera-opennlp) document for details on using the component's features in a SQL query.
